...
|velocity|Reference epoch t~0~ +
Velocity __v__|f(__t__) = __v__.(t - t~0~) all values of t
|acceleration|Reference epoch t~0~ +
Acceleration __a__|f(__t__) = __a__.(t - t~0~)^2^ all values of t
...
Start amplitude &#945;~0~ +
Final amplitude &#945;~∞~ +
Decay constant θ| f(__t__) = 0     when __t__ < t~0~ 

f(__t__) = &#945;~0~ + (&#945;~∞~-&#945;~0~).(1 - exp(-(__t__-t~0~)/θ))     when t~0~ <= __t__ 
