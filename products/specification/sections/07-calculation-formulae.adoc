...
The step function is a specialization of the ramp function, provided to improve simplicity and readability for the most common use of it to represent coseismic deformation.
