...
|logarithmic footnote:log10[The logarithmic function uses a natural logarithm (base _e_).  A base 10 logarithmic function can be emulated by using a scale factor s = 1.0/ln(10.0) &#8776; 0.434294]|Event epoch t~v~ +
Time constant &#964; | f~r~(_t_) = 0 for _t_ < t~v~ +
