:Title: OGC CRS DWG Deformation Model Functional Model Project Team Report
:titletext: Deformation Model Functional Model
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
include::clause_2_definition.adoc[]

<<<
//use annexes as needed
include::annex-a-glossary.adoc[]
